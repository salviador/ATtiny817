 ...
 */
static inline void T0_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(6, pull_mode);
}

/**
 * \brief Set T0 data direction
 *
 ...
 *                      (low power state)
 */
static inline void T0_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(6, dir);
}

/**
 * \brief Set T0 input/sense configuration
 *
 * Enable/disable T0 digital input buffer and pin change interrupt,
 ...
 */
static inline void T0_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(6, isc);
}

/**
 * \brief Set T0 inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on T0 is inverted
 *                     false = I/O on T0 is not inverted
 */
static inline void T0_set_inverted(const bool inverted)
{
 ...
 */
static inline void T0_set_level(const bool level)
{
	PORTA_set_pin_level(6, level);
}

/**
 * \brief Toggle output level on T0
 *
 * Toggle the pin level
 */
static inline void T0_toggle_level()
{
	PORTA_toggle_pin_level(6);
}

/**
 * \brief Get level on T0
 *
 * Reads the level on a pin
 */
static inline bool T0_get_level()
{
	return PORTA_get_pin_level(6);
}

/**
 * \brief Set T1 pull mode
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] pull_mode Pin pull mode
 */
static inline void T1_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(7, pull_mode);
}

/**
 * \brief Set T1 data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void T1_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(7, dir);
}

/**
 * \brief Set T1 input/sense configuration
 *
 * Enable/disable T1 digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_INTDISABLE_gc    = Iterrupt disabled but input buffer enabled
 *                PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void T1_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(7, isc);
}

/**
 * \brief Set T1 inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on T1 is inverted
 *                     false = I/O on T1 is not inverted
 */
static inline void T1_set_inverted(const bool inverted)
{
 ...
 *                  false = Pin level set to "low" state
 */
static inline void T1_set_level(const bool level)
{
	PORTA_set_pin_level(7, level);
}

/**
 * \brief Toggle output level on T1
 *
 * Toggle the pin level
 */
static inline void T1_toggle_level()
{
	PORTA_toggle_pin_level(7);
}

/**
 * \brief Get level on T1
 *
 * Reads the level on a pin
 */
static inline bool T1_get_level()
{
